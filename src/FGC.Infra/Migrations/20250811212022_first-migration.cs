...
namespace FGC.Infra.Migrations
{
    /// <inheritdoc />
    public partial class firstmigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGamesLibrary", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGamesLibrary_Games_GameId",
                        column: x => x.GameId,
                        principalTable: "Games",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserGamesLibrary_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "GamesLibraryGameId",
                table: "UserGamesLibrary",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "GamesLibraryUserId",
                table: "UserGamesLibrary",
                column: "UserId");
